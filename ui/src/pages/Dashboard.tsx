    ...
    if (companies.length === 0) {
      return (
        <EmptyState
          ...
          message={t("onboarding.getStarted")}
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-red-50">
                    {data.budgets.activeIncidents} {t("dashboard.activeBudgetIncidents")}
                  </p>
                  <p className="text-xs text-red-100/70">
                    {data.budgets.pausedAgents} {t("dashboard.agentsPaused")} · {data.budgets.pausedProjects} {t("dashboard.projectsPaused")} · {data.budgets.pendingApprovals} {t("dashboard.pendingBudgetApprovals")}
                  </p>
                </div>
              </div>
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? `${data.costs.monthUtilizationPercent}% ${t("dashboard.ofBudget", { budget: formatCents(data.costs.monthBudgetCents) })}`
