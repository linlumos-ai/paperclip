...
export function GoalDetail() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("goals.goalsBreadcrumb"), href: "/goals" },
      { label: goal?.title ?? goalId ?? t("goals.goalBreadcrumb") }
    ]);
      ...
      <Tabs defaultValue="children">
        <TabsList>
          ...
          <TabsTrigger value="projects">
            {t("goals.projects")} ({linkedProjects.length})
          </TabsTrigger>
        </TabsList>
